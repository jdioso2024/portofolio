...
export default function About() {
    ...
    useEffect(() => {
        const updateHeight = () => {
            if (sectionRef.current) setAboutHeight(sectionRef.current.offsetHeight);
        };
        // Delay slightly on mount so fonts logic applies, wait just 1 frame
    ...
    return (
        <>
            <div id="about" style={{ position: "relative", top: -80 }} />
            <section
                ref={sectionRef}
                style={{
                    position: "sticky",
                    top: aboutHeight ? `min(0px, calc(100vh - ${aboutHeight}px - 80px))` : "-1000px",
                    zIndex: 1,
                        ...
                        >
                            ...
                            <div
                                ...
                                <img
                                    ...
                                    alt="Ariefin Nur Hidayat — profile photo"
                                    style={{
                                        position: "absolute",
                                        inset: 0,
                                        width: "100%",
